...
import 'package:traffic/utils/models/auto_complete.dart';
...
import '../utils/providers/search_places_results.dart';
...
//Markers set
  ...
  final key = 'AIzaSyA2c9JnAfwmLnn98nCVHELAbLDiy8jM_cM';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            user == null || currentLocation == null
                ? const Center(
                    child: SafeArea(
      ...
      floatingActionButton: CircularMenu(items: [
        CircularMenuItem(
            icon: Icons.menu,
            onTap: () {
